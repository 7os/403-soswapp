...
<html lang="en" dir="ltr" manifest="<?php echo WHOST; ?>/site.webmanifest">
  ...
  <body>
    <?php \TymFrontiers\Helper\setup_page('403','base', true, PRJ_HEADER_HEIGHT); ?>
    <?php include PRJ_INC_HEADER; ?>
    <section id="main-content">
      <div class="view-space">
        <div class="sec-div padding -p20">
          <h1> <i class="fas fa-exclamation-triangle fa-2x"></i> Forbidden!</h1>
          ...
          <p>
            <?php if (!empty($params["message"])){
              ...
              echo "It's forbidden to make such request here.";
            } ?>
          </p>
